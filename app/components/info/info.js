    ...
    return (
        <div class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-10 mx-auto">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Discover <span class="underline decoration-blue-500">FlyJets</span></h1>

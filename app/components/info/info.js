            ...
            <div className="container px-6 py-10 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2">
                    <div className="bg-gray-100 rounded-lg dark:bg-gray-800">
                        <div className="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 w-auto group" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1625513123245-fcb02d69ad12?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80)'}} onClick={()=>window.searchModal.showModal()}>
                    ...
                    <div className=" bg-gray-100 rounded-lg dark:bg-gray-800">
                        <div className="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 w-auto group" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1474302770737-173ee21bab63?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1808&q=80)'}} onClick={()=>window.proposeInfo.showModal()}>
                            <div className="flex flex-col justify-between w-full h-full px-5 pb-4 transition-opacity duration-700 backdrop-blur-sm group-hover:bg-slate-500/30">
                                <button className="mt-8 absolute right-8 py-1 w-24 text-xs text-white capitalize font-thin transition-colors duration-300 transform bg-gray-800 rounded dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">view more</button>
                                <div>

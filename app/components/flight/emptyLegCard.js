...
function EmptyLegCard({city}) {
    ...
    return (
        <div className="w-full max-w-xs text-align cursor-pointer ">
            <div className="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group hover:outline hover:outline-2 outline-offset-2 outline-slate-300 solid" style={{backgroundImage: `url(/images/destinations/${city.destination.toLowerCase()}.jpg)`}}>

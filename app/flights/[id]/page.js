      ...
      <div className="container px-6 pt-16 mx-auto">
        <div className="max-w-lg">
          <div className="flex gap-4">
            ...
            <button className="bg-blue-400 rounded-lg text-sm sm:text-base flex items-center gap-x-3 justify-center text-white hover:bg-fuchsia-600 duration-300 transition-colors border border-transparent px-8 py-2.5 mb-5">
                Empty Leg Flight
            </button>
          </div>
        ...
        <div className=" lg:flex">
          <div className="w-full lg:w-1/2">
            ...
            <div className="lg:max-w-lg">
              ...
              <p className="mt-1 text-gray-600 dark:text-gray-400">
                <span className="font-bold">Flugzeug GmbH</span> is our main airplane partner and supplier since 2023.
              </p>
            </div>
            <hr className="my-6 border-gray-200 dark:border-gray-700" />
            <div className="lg:max-w-lg">

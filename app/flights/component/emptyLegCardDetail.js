    ...
    return (
        <div className="mt-12 space-y-8">
            <Link href={flight.flight_category === "sharing" ? `/sharing/${flight.id}` : `/flights/${flight.id}`}>
                <div className="flex overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:outline hover:outline-2 outline-offset-2 outline-slate-300 solid cursor-pointer duration-200 hover:scale-105 group">
                    ...
                    <div className="w-3/4 px-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <div className="flex items-center justify-between">
                            <span className="text-sm font-light text-gray-600 dark:text-gray-400 group-hover:font-bold">{flight.date}</span>
                            <div className="uppercase px-3 py-1 text-sm font-bold text-slate-300 group-hover:text-slate-600 dark:group-hover:text-blue-600 transition-colors duration-300 transform rounded cursor-pointer hover:bg-gray-500 hover:text-white dark:text-white">More info</div>
                        </div>
                        <div className="mt-2">
                            ...
                            <div className="w-full inline-flex justify-between py-3">
                                ...
                                <div className="my-auto text-slate-800 dark:text-white">
                                    <p className="font-semibold text-center">3hrs 30mins</p>
